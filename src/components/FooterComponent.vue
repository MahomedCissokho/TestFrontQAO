<script setup>
    import logovariant from '../assets/logovariant.png'
  ...
  <template>
    <footer class="p-4 text-white bg-[#1A0007] rounded-t-3xl ">
      <div class="flex flex-col items-center justify-between max-w-6xl mx-auto sm:flex-row">
        <div class="flex items-center mb-4 sm:mb-0">
          <img :src=logovariant alt="Art Institute Chicago" class="w-auto h-10 mr-2">
